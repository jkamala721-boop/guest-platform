...
@AutoConfigureMockMvc @ActiveProfiles("test") class AdminHostNotesTimelineIntegrationTest {
 ...
 @Test void timelineIncludesAgreementBookingAndPayoutWithoutOperationalSecrets() throws Exception {
  ...
  Property property=new Property(host);property.update("Timeline Property",PropertyType.APARTMENT,"Nairobi","https://maps.example/timeline",null,null,2,new BigDecimal("3500"),"KES",LocalTime.of(14,0),LocalTime.of(10,0),null,null,null,null,"+254700000000",true,null,null,null,null,null);properties.saveAndFlush(property);
