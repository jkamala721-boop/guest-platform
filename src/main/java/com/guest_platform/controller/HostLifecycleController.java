...
public class HostLifecycleController {
 private final HostVerificationService verification; private final HostAgreementService agreements; private final HostOnboardingService onboarding;
 public HostLifecycleController(HostVerificationService verification,HostAgreementService agreements,HostOnboardingService onboarding){this.verification=verification;this.agreements=agreements;this.onboarding=onboarding;}
